...
/**
 * Servlet implementation class EncargadoAlta
 */
@WebServlet("/EncargadoAlta")
public class EncargadoAlta extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EncargadoAlta() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usuarioLogic.validarContrasenias(password, password2)) {
			...
			user.setRol(usuarioLogic.setRol(2));
